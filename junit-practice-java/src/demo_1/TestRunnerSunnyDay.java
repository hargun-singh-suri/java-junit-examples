...
public class TestRunnerSunnyDay {

	public static void main(String args[]) {
		/*# Use runClasses method of JUnitCore class of JUnit to run the test case of the created test class.*/
		/*# Get the result of test cases run in Result Object.*/
		Result result = JUnitCore.runClasses(TestMessageUtilSunnyDay.class);
